...
KCM.SimpleKCM {
    Kirigami.FormLayout {
        ...
        QQC2.CheckBox { text: i18n("Simulation only (do not control the desktop)"); checked: kcm.dryRun; onToggled: { kcm.dryRun = checked; kcm.changed() } }
        ...
        Kirigami.InlineMessage { Kirigami.FormData.isSection: true; visible: kcm.enabled || !kcm.serviceReady; type: kcm.serviceReady ? Kirigami.MessageType.Positive : Kirigami.MessageType.Warning; text: kcm.serviceSummary }
